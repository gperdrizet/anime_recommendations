...
A content-based filtering recommendation system that suggests similar anime titles based on genre similarity using the Jaccard distance metric. This repository demonstrates set-up and deployment of a simple Streamlit web application.
